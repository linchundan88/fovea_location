...
dir_preprocess = '/media/ubuntu/data2/Fover_center/DR0_4_inconsistent/512/original'
dir_preprocess_fovea = '/media/ubuntu/data2/Fover_center/DR0_4_inconsistent/512/fovea'

dir_tmp = '/tmp2/DR0_4_inconsistent/'

preprocess_image_size = 512

filename_csv = os.path.join(os.path.abspath('.'), 'DR0_4_inconsistent.csv')
...
with open(filename_csv, 'w', newline='') as csvfile:
    ...
    for dir_path, subpaths, files in os.walk(dir_preprocess, False):
        for f in files:
            ...
            file_macular =  full_filename.replace(dir_preprocess, dir_preprocess_fovea)
